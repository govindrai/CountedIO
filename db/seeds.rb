...
Meal.create(user_id: 16, food_name: "Chicken", calories: 123, quantity: 2, meal_type: "Breakfast", original_description: "lala")

Meal.create(user_id: 16, food_name: "Celery", calories: 5, quantity: 5, meal_type: "Breakfast", original_description: "lala")

Meal.create(user_id: 16, food_name: "Waffles", calories: 450, quantity: 2, meal_type: "Breakfast", original_description: "lala")

Meal.create(user_id: 16, food_name: "Ice Cream", calories: 200, quantity: 1, meal_type: "Breakfast", original_description: "lala")

Meal.create(user_id: 16, food_name: "Cereal", calories: 400, quantity: 1, meal_type: "Lunch", original_description: "lala")

Meal.create(user_id: 16, food_name: "Sandwich", calories: 300, quantity: 1, meal_type: "Lunch", original_description: "lala")

Meal.create(user_id: 16, food_name: "ham", calories: 150, quantity: 3, meal_type: "Dinner", original_description: "lala")

Meal.create(user_id: 16, food_name: "Grilled Chicken Breast", calories: 300, quantity: 1, meal_type: "Dinner", original_description: "lala")

Meal.create(user_id: 16, food_name: "Cake", calories: 300, quantity: 1, meal_type: "Dinner", original_description: "lala")
Meal.create(user_id: 16, food_name: "Cake", calories: 300, quantity: 1, meal_type: "Snack", original_description: "lala")
Meal.create(user_id: 16, food_name: "Cake", calories: 300, quantity: 1, meal_type: "Snack", original_description: "lala")
Meal.create(user_id: 16, food_name: "Cake", calories: 300, quantity: 1, meal_type: "Snack", original_description: "lala")
